...
import * as sty from "./PlasmicListItem.module.css"; // plasmic-import: xzTiigoH4iJQ/css
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <Icon16Icon
            className={classNames(defaultcss.all, sty.svg___6Ig7G)}
            role={"img"}
          />
        ),
