...
import Testimonial from "../../Testimonial"; // plasmic-import: J8IQfN4Pt6hP/component
...
import * as sty from "./PlasmicTestimonialsSection1.module.css"; // plasmic-import: sNRVC2LOkBOM/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__wd2Bu)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__dYvZ)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames(
                  "__wab_instance",
                  sty.testimonial___5PKep
                )}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__fC4G)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__hOeD)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img__rgExg)}
                    role={"img"}
                    src={
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__zmOQv)}
                slot={
                  <img
                    alt={""}
                    className={classNames(defaultcss.img, sty.img___6O9B4)}
                    role={"img"}
                    src={
