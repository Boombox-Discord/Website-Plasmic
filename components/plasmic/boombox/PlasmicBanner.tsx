...
import * as sty from "./PlasmicBanner.module.css"; // plasmic-import: veXJF2v7acJs/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__rikXl)}
              role={"img"}
              src={
          ...
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                children2={
                  <svg
                    className={classNames(defaultcss.all, sty.svg__aE18U)}
                    role={"img"}
                  />
                }
                slot={
              ...
              >
                <svg
                  className={classNames(defaultcss.all, sty.svg__xDon8)}
                  role={"img"}
                />
              </Button>
            </React.Fragment>
