...
import * as sty from "./PlasmicLogoCloudSection2.module.css"; // plasmic-import: MhxoujITqQog/css
        ...
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__w9J8F)}
                role={"img"}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__hFN1)}
                role={"img"}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__sjEKu)}
                role={"img"}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__i9Wsh)}
                role={"img"}
              />

              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__rk06Q)}
                role={"img"}
              />
            </React.Fragment>
          ),
