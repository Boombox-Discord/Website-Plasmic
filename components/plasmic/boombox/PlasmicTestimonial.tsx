...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: J8IQfN4Pt6hP/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__ppW5)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__kpVvO)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__ooFBr)}
              role={"img"}
            />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__pqtCs)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__aD4F)}>
            {p.renderPlasmicSlot({
